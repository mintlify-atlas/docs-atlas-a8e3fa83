...
<Steps>
  ...
  <Step title="Configure Extension Settings">
    ...
    **Copy each value:**
    ...
    <Note>
      **Auto-configuration coming soon:** The extension will auto-sync these values when you visit `/app/platforms` (see [Extension Auto-Config Guide](https://github.com/geniehelper/docs/extension-auto-configuration-guide.md)).
    </Note>
  </Step>
